...
namespace TomyChimmy.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var tomyChimmyDbContext = _context.Invoices.Include(i => i.PayingMethod);
        ...
        public async Task<IActionResult> Create([Bind("Invoice_ID,Id,Method_Id,FechaFactura,Subtotal,ValorImpuesto,Total")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Invoice_ID,Id,Method_Id,FechaFactura,Subtotal,ValorImpuesto,Total")] Invoice invoice)
        {
